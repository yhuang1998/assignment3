...
/**
 * This progrom is going to count how many times each word appear. 
 * The input is a text file with lyrics.
 * To scan and count word. 
 */
...
public class WordCount {
  ...
  public static void main( String[] args ) throws FileNotFoundException  {
   ...
   Scanner input = new Scanner(new File("word.txt"));
    ...
    // count occurrences
    //replace the punctuation and make it to lower case.
